...
public class JWTService {
    ...
    private boolean rolesMatch(UserDetails userDetails, List<String> tokenRoles) {
        if (tokenRoles == null) return false;

        Set<String> userRoles = getRolesFromUserDetails(userDetails);
        return userRoles.containsAll(tokenRoles) && new HashSet<>(tokenRoles).containsAll(userRoles);
    }

    private Set<String> getRolesFromUserDetails(UserDetails userDetails) {
